...
function multiplyNumbers() {
  ...
  let mulitplyNumber2 = Number(document.querySelector("#factor2").value);
...
document.querySelector("#evens").innerHTML = numbersArray
  .filter((number) => number % 2 === 0)
  .toString();

/* Output Sum of Org. Array */
document.querySelector("#sumOfArray").innerHTML = numbersArray
